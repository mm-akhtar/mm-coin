...
# Crete a Cryptocurrency

# To be installed 
# flassk  pip install flask==0.12.2
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Altamash', amount = 1)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The mm-coin Block chain contains the following nodes:',
